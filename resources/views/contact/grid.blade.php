        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        @include('contact.autocomplete', ['contacts_names' => $contacts_names])
                        <div class="col-4">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($contacts as $contact)
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-danger" {{ $contact->is_user_contact ? "disabled" : "" }} onclick="deleteContact({{ $contact->id }})">
